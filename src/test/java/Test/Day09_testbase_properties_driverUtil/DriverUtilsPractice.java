...
import Test.Day09_testbase_properties_driverUtil.office.Singleton;
...
public class DriverUtilsPractice {
    ...
    public void driver_practice(){
        ...
        googleSearch.sendKeys(ConfigurationReader.getProperty("testdata") + Keys.ENTER); //come through my utility
