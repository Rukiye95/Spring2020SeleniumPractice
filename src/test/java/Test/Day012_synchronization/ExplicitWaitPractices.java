package Test.Day012_synchronization;
...
public class ExplicitWaitPractices {
    ...
    // 3.Assert : Message “Done” is displayed.4.Assert : Image is displayed.Note: Follow POM
    ...
    public void tc40_dynamic_title_test(){
       String url="http://practice.cybertekschool.com/dynamic_loading/7" ;
        ...
        //creating the instance of WebDriverWait to use its method
