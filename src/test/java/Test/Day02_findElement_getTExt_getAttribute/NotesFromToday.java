...
LOCATORS : There are 8 different types of locators in Selenium
	1- name: This locator will be looking into the whole HTML code, and return the WebElement with matching name attribute value
		- it will find and return the first web element it finds
...
.click();
	--> clicks to the web element that we located
	--> does not accept any arguments
...
2- linkText:
	...
	How do I know if the web Element is a link or not?
...
.getAttribute("attribute name") -->
	...
	1- we need to locate the web element
