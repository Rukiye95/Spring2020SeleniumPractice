...
--> What is a WebElement?
	- Everything we see on the web page such as links, buttons, input boxes, checkboxes, images are web elements on the page.
...
4- tagName: locates the webElement by tagName itself.
	...
	- Useful usually when you want to return the same type of web elements and store them in a List and do some action on them.
...
LOCATING WEB ELEMENT ON LINE B:
	- //div[@name='h131'] --> locates the web element on line B
...
// after refresh, driver will not be able to do any action on checkbox web element, UNTIL WE RELOCATE/REFRESH the reference.
