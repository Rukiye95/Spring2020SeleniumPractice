...
button.click();
    ...
    public void t2(){
        ...
        Alert alert=driver.switchTo().alert();
        alert.accept();
        WebElement result2=driver.findElement(By.xpath("//p[.='You clicked: Ok']"));
        System.out.println(result2.isDisplayed());
...
@Test
    public void t3(){
        ...
        Alert alert=driver.switchTo().alert();
        alert.accept();
        WebElement result3=driver.findElement(By.xpath("//p[.='You entered: ']"));
           System.out.println(result3.isDisplayed());
